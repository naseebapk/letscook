...
public class Ingredient extends Activity implements View.OnClickListener{
    //    EditText imeage_id;
    EditText Name;
    Button ADD;
    SQLiteDatabase db;
    ...
    public void onClick(View v) {
        ...
        {
            Toast.makeText(Ingredient.this,"please enter values",Toast.LENGTH_SHORT).show();

        }
        db.execSQL("INSERT INTO addingredients VALUES('"+Name.getText()+"');");
        Toast.makeText(Ingredient.this,"Success",Toast.LENGTH_SHORT).show();
